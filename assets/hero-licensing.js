...
export const HERO_SLIDES = [
  ...
  },
  {
    ...
    sub: "Explore Cortex directly under the community edition license — no sales conversation required to start learning.",
  ...
  },
  {
    ...
    pilotNote: true,
    proof: [
      { label: "Platform license", detail: "$499/mo — Cortex commercial access." },
